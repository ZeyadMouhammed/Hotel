...
public class Triple extends Room implements Serializable {

    private static int Area;
    private static String View;
    private static int pricePerDay;
    private static final int NumberOfBeds = 3;
    private static int roomID = 3;
    ...
    public Triple(int area, String view, int price) {
        NumOfRooms++;
        Area = area;
        View = view;
        pricePerDay = price;
